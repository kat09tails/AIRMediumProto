            ...
            <div id="main-component">
               <Container id="button-grid" class ="centered">
                  <Row>
                     ...
                     <Col id="col"><Button href = './buttonresults' id="navbar-button" variant="outline-dark"><Image src={food} height="50%" width="50%" /><h1 id='btn-text'>Food</h1></Button></Col>
                     <Col id="col"><Button href = './buttonresults' id="navbar-button" variant="outline-dark"><Image src={housing} height="50%" width="50%" /><h1 id='btn-text'>Housing</h1></Button></Col>
                  </Row>
                  <Row>
                     <Col id="col"><Button href = './buttonresults' id="navbar-button" variant="outline-dark"><Image src={goods} height="50%" width="50%" /><h1 id='btn-text'>Goods</h1></Button></Col>
                     <Col id="col"><Button href = './buttonresults' id="navbar-button" variant="outline-dark"><Image src={transit} height="50%" width="50%" /><h1 id='btn-text'>Transit</h1></Button></Col>
                     <Col id="col"><Button href = './buttonresults' id="navbar-button" variant="outline-dark"><Image src={health} height="50%" width="50%" /><h1 id='btn-text'>Health</h1></Button></Col>
                  </Row>
                  <Row>
                     <Col id="col"><Button href = './buttonresults' id="navbar-button" variant="outline-dark"><Image src={money} height="50%" width="50%" /><h1 id='btn-text'>Money</h1></Button></Col>
                     <Col id="col"><Button href = './buttonresults' id="navbar-button" variant="outline-dark"><Image src={care} height="50%" width="50%" /><h1 id='btn-text'>Care</h1></Button></Col>
                     <Col id="col"><Button href = './buttonresults' id="navbar-button" variant="outline-dark"><Image src={education} height="50%" width="50%" /><h1 id='btn-text'>Education</h1></Button></Col>
                  </Row>
                  <Row>
                     <Col id="col"><Button href = './buttonresults' id="navbar-button" variant="outline-dark"><Image src={work} height="40%" width="40%" /><h1 id='btn-text'>Work</h1></Button></Col>
