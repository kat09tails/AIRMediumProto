...
export default class Survey extends React.Component {
   ...
   renderButton() {
      if(this.state.mode === 'survey1'){
         return ( 
            <div>
               <Button onClick={this.handleContinue} id="survey_button" id="continue_button" variant='dark'>Continue</Button>
            </div>
         );
      }
      else{
         return ( 
            <div id="prev_and_results_button">
               <Button onClick={this.handlePrevious} id="survey_button" id="previous_button" variant='dark'>Previous</Button>
               <Button href='/resultspage' id="survey_button" id="see_results_button" variant='dark'>See Results</Button>
   ...
   render (){
      return (
         <div id='main_component_survey'>
            ...
            {this.renderButton()}
            <Button href="/" variant='dark' id="exit_button">Exit</Button>
         </div>
      );
   }
